    ...
    public partial class frmData : Form
    {
        ...
        public void UpdateData(int powerID)
        {
            ...
            if (powerID > -1)
            {
                ...
                iPopup.Sections[index2].Add("Power Type:", PopUp.Colors.Text, Enum.GetName(power1.PowerType.GetType(), (object)power1.PowerType), PopUp.Colors.Text, 0.9f, System.Drawing.FontStyle.Bold, 1);
                    ...
                    for (int index3 = 1; index3 <= num; ++index3)
                    {
                        if ((power1.AttackTypes & (Enums.eVector)values[index3]) > Enums.eVector.None)
                        {
                            ...
                            if (flag)
                            {
                                ...
                                iText = "";
                            iPopup.Sections[index2].Add(iText, PopUp.Colors.Text, Enum.GetName(power1.AttackTypes.GetType(), (object)values[index3]), PopUp.Colors.Text, 0.9f, System.Drawing.FontStyle.Bold, 1);
                        }
                    }
                }
                ...
                iPopup.Sections[index2].Add("Effect Area:", PopUp.Colors.Text, Enum.GetName(power1.EffectArea.GetType(), (object)power1.EffectArea), PopUp.Colors.Text, 0.9f, System.Drawing.FontStyle.Bold, 1);
                ...
                iPopup.Sections[index2].Add("Auto-Hit:", PopUp.Colors.Text, Enum.GetName(power1.EntitiesAutoHit.GetType(), (object)power1.EntitiesAutoHit), PopUp.Colors.Text, 0.9f, System.Drawing.FontStyle.Bold, 1);
                ...
                iPopup.Sections[index2].Add("Notify Mobs:", PopUp.Colors.Text, Enum.GetName(power1.AIReport.GetType(), (object)power1.AIReport), PopUp.Colors.Text, 0.9f, System.Drawing.FontStyle.Bold, 1);
                ...
                iPopup.Sections[index2].Add("Target:", PopUp.Colors.Text, Enum.GetName(power1.EntitiesAffected.GetType(), (object)power1.EntitiesAffected), PopUp.Colors.Text, 0.9f, System.Drawing.FontStyle.Bold, 1);
