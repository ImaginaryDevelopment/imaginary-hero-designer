...
namespace Hero_Designer
{
    public partial class frmCompare : Form
    {
        ...
        static string GetUniversalTipString(Enums.ShortFX iSFX, ref IPower iPower)
        {
            const string str1 = "";
            string str2;
            if (iSFX.Present)
            {
                ...
                for (int index1 = 0; index1 <= num1; ++index1)
                {
                    if (iSFX.Index[index1] == -1 ||
                        power.Effects[iSFX.Index[index1]].EffectType == Enums.eEffectType.None) continue;
                    string returnString = "";
                ...
                {
                    if (power.Effects[iSFX.Index[index]].EffectType == Enums.eEffectType.None) continue;
                    if (str3 != "")
                        str3 += "\r\n  ";
            ...
            for (int index1 = 0; index1 <= num4; ++index1)
            {
                ...
                for (int index2 = 0; index2 <= num5; ++index2)
                {
                    if (!(string.Equals(Powers[0][index2].DisplayName, displayName,
                              StringComparison.OrdinalIgnoreCase) & !Placed[index1])) continue;
        ...
        "knockback"
            ...
            {
                if (Placed[index] || Map.Map[index, 1] != -1) continue;
        ...
        public int mapDescString(string[] iStrings, ref bool[] placed)
        {
            ...
            for (int powerIdx = 0; powerIdx <= Powers[1].Length - 1; ++powerIdx)
            {
                ...
                if (!(flag1 & !placed[powerIdx])) continue;
                {
        ...
        void values_Accuracy()
        {
            ...
            do
            {
                ...
                for (int index2 = 0; index2 <= num2; ++index2)
                {
                    ...
                    if (Values[index1][index2] == 0.0) continue;
                    {
        ...
        void values_Damage()
        {
            ...
            do
            {
                ...
                for (int index2 = 0; index2 <= num2; ++index2)
                {
                    ...
                    if (num1 < (double)Values[index1][index2])
                        num1 = Values[index1][index2];
                    if (Powers[index1][index2].PowerType != Enums.ePowerType.Toggle) continue;
                    {
                        string[][] tips2 = Tips;
                        int index3 = index1;
                        int index4 = index2;
        ...
        void values_DPE()
        {
            ...
            do
            {
                for (int subPowIdx = 0; subPowIdx <= Powers[powIdx].Length - 1; ++subPowIdx)
                {
                    ...
                    if (Values[powIdx][subPowIdx] == 0.0) continue;
