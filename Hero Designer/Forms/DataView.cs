...
namespace Hero_Designer
{
    public class DataView : UserControl
    {
                ...
                else
                {
                    ...
                    for (int index1 = 0; index1 <= num5; ++index1)
                    {
                        if (MidsContext.Character.CurrentBuild.Powers[index1].Power == null ||
                            !MidsContext.Character.CurrentBuild.Powers[index1].StatInclude) continue;
                    ...
                    for (int index = 0; index <= num6; ++index)
                    {
                        ...
                        if (!(numArray3[index] > 0.0)) continue;
                    ...
                    {
                        if (!(numArray4[index] > 0.0)) continue;
        ...
        void display_Info(bool NoLevel = false, int iEnhLvl = -1)
        {
            ...
            {
                if (num3 <= 0 || rankedEffects[ID] <= -1) continue;
                ...
                if (!(pBase.Effects[rankedEffects[ID]].Probability > 0.0 &
                      ...
                      Enums.eSuppress.None & pBase.Effects[rankedEffects[ID]].CanInclude())) continue;
        ...
        int effects_BuffDebuff(Control iLabel, ctlPairedList iList)
        {
            ...
            else
            {
                ...
                {
                    if (!shortFxArray[index1].Present) continue;
                    bool flag = true;
                    int num3 = shortFxArray[index1].Index.Length - 1;
                    for (int index2 = 0; index2 <= num3; ++index2)
                    {
                        if (pEnh.Effects[shortFxArray[index1].Index[index2]].SpecialCase ==
                            Enums.eSpecialCase.Defiance) continue;
                        flag = false;
                        break;
                    }

                    iList.AddItem(flag
                        ? new ctlPairedList.ItemPair("Defiance:", Utilities.FixDP(shortFxArray[index1].Value[0]) + "%",
                            false, false, false,
                            pEnh.Effects[shortFxArray[index1].Index[0]]
                                .BuildEffectString(false, "Damage Buff (Defiance)"))
                        : new ctlPairedList.ItemPair("DmgBuff:", Utilities.FixDP(shortFxArray[index1].Value[0]) + "%",
                            false, pEnh.Effects[shortFxArray[index1].Index[0]].SpecialCase == Enums.eSpecialCase.Combo,
                        ...
                        if (effectMagSum10.Index.Length < 5)
                        {
                            ...
                            for (int index = 0; index <= num3; ++index)
                            {
                                ...
                                if (pEnh.Effects[effectMagSum10.Index[index]].ToWho == Enums.eToWho.Self)
                                    str5 = " (Self)";
                                if (str4.IndexOf("Jump", StringComparison.OrdinalIgnoreCase) > -1) continue;
        ...
        int effects_Elusivity(Control iLabel, ctlPairedList iList)
        {
            ...
            for (int idEffect = 0; idEffect <= num2; ++idEffect)
            {
                if (!(pBase.Effects[idEffect].EffectType == Enums.eEffectType.Elusivity &
                      pBase.Effects[idEffect].Probability > 0.0)) continue;
        ...
        int effects_GrantPower(Control iLabel, ctlPairedList iList)
        {
            bool flag = iList.ItemCount == 0;
            int num1 = 0;
            int num2 = pBase.Effects.Length - 1;
            for (int index = 0; index <= num2; ++index)
            {
                if (!(pBase.Effects[index].EffectType == Enums.eEffectType.GrantPower &
                      ...
                      pBase.Effects[index].EffectClass != Enums.eEffectClass.Ignored)) continue;
                string iValue = "[Power]";
        ...
        int effects_Heal(Control iLabel, ctlPairedList iList)
        {
            ...
            else
            {
                ...
                if (shortFx.Present)
                {
                    ...
                    for (int index = 0; index <= num3; ++index)
                    {
                        if (pBase.Effects[shortFx.Index[index]].Aspect != Enums.eAspect.Cur) continue;
        ...
        int effects_ModifyEffect(Control iLabel, ctlPairedList iList)
        {
            bool flag = iList.ItemCount == 0;
            int num1 = 0;
            int num2 = pBase.Effects.Length - 1;
            for (int index = 0; index <= num2; ++index)
            {
                if (!(pBase.Effects[index].EffectType == Enums.eEffectType.GlobalChanceMod &
                      pBase.Effects[index].Probability > 0.0)) continue;
        ...
        int effects_Movement(Control iLabel, ctlPairedList iList)
        {
        ...
        int effects_Status(Control iLabel, ctlPairedList iList)
        {
            ...
            if (shortFx3.Present)
            {
                ...
                for (int iTagID = 0; iTagID <= num2; ++iTagID)
                {
                    if (!(pBase.Effects[iTagID].EffectType == Enums.eEffectType.Mez &
                          pBase.Effects[iTagID].Probability > 0.0 & pBase.Effects[iTagID].CanInclude()) ||
                        !pEnh.Effects[iTagID].PvXInclude()) continue;
                    const bool iAlternate1 = false;
            ...
            if (!shortFx1.Present) return num1;
            {
                int num2 = pBase.Effects.Length - 1;
                for (int iTagID = 0; iTagID <= num2; ++iTagID)
                {
                    if (!(pBase.Effects[iTagID].PvMode != Enums.ePvX.PvP & !MidsContext.Config.Inc.DisablePvE |
                        ...
                        !(pBase.Effects[iTagID].EffectType == Enums.eEffectType.MezResist &
                          pBase.Effects[iTagID].Probability > 0.0)) continue;
        ...
        int effects_Summon(Control iLabel, ctlPairedList iList)
        {
            int num1 = 0;
            bool flag = iList.ItemCount == 0;
            int num2 = pBase.Effects.Length - 1;
        ...
        void EffectsDef()
        {
            ...
            if (effectMagSum.Value == null)
                return;
            const Enums.eDamage eDamage = Enums.eDamage.None;
            ...
            const Enums.eDamage iSub1 = Enums.eDamage.Smashing;
            if (multiple)
            ...
            if (sFXCheck(effectMagSum))
                fx_List1.SetUnique();
            const Enums.eDamage iSub2 = Enums.eDamage.Fire;
            if (multiple)
            ...
            if (sFXCheck(effectMagSum))
                fx_List1.SetUnique();
            const Enums.eDamage iSub3 = Enums.eDamage.Lethal;
            if (multiple)
            ...
            if (sFXCheck(effectMagSum))
                fx_List1.SetUnique();
            const Enums.eDamage iSub4 = Enums.eDamage.Cold;
            if (multiple)
            ...
            if (sFXCheck(effectMagSum))
                fx_List1.SetUnique();
            const Enums.eDamage iSub5 = Enums.eDamage.Energy;
            if (multiple)
            ...
            if (sFXCheck(effectMagSum))
                fx_List1.SetUnique();
            const Enums.eDamage iSub6 = Enums.eDamage.Melee;
            if (multiple)
            ...
            if (sFXCheck(effectMagSum))
                fx_List1.SetUnique();
            const Enums.eDamage iSub7 = Enums.eDamage.Negative;
            if (multiple)
            ...
            if (sFXCheck(effectMagSum))
                fx_List1.SetUnique();
            const Enums.eDamage iSub8 = Enums.eDamage.Ranged;
            if (multiple)
            ...
            if (sFXCheck(effectMagSum))
                fx_List1.SetUnique();
            const Enums.eDamage iSub9 = Enums.eDamage.Psionic;
            if (multiple)
            ...
            if (sFXCheck(effectMagSum))
                fx_List1.SetUnique();
            const Enums.eDamage iSub10 = Enums.eDamage.AoE;
            if (multiple)
        ...
        int EffectsDrh()
        {
            ...
            if (!pBase.HasResEffects()) return index;
            EffectsRes(index);
            ++index;
            return index;
        }
        ...
        void EffectsRes(int index)
        {
            ...
            if (sFXCheck(shortFx))
                ctlPairedList.SetUnique();
            const Enums.eDamage iSub6 = Enums.eDamage.Psionic;
            ...
            if (sFXCheck(shortFx))
                ctlPairedList.SetUnique();
            const Enums.eDamage iSub8 = Enums.eDamage.Toxic;
          ...
          Enums.eEnhGrade Grade2)
        {
            ...
            if (pBase == null)
                return;
            SolidBrush solidBrush2 = new SolidBrush(Color.FromArgb(160, 0, 0, 0));
            if (PowerID != pBase.PowerIndex) return;
            ImageAttributes recolourIa = clsDrawX.GetRecolourIa(MidsContext.Character.IsHero());
            Rectangle rectangle1 = new Rectangle();
            ref Rectangle local1 = ref rectangle1;
            Size size = bxFlip.Size;
        ...
        ctlPairedList.ItemPair GetRankedEffect(IReadOnlyList<int> Index, int ID)
        {
            ...
            if (Index[ID] > -1)
            {
                const Enums.eEffectTypeShort eEffectTypeShort = Enums.eEffectTypeShort.None;
                bool flag = false;
                ...
                switch (pBase.Effects[Index[ID]].EffectType)
                {
                    ...
                    default:
                    {
                        if (pBase.Effects[Index[ID]].EffectType == Enums.eEffectType.Mez & (pBase.Effects[Index[ID]].MezType == Enums.eMez.Taunt | pBase.Effects[Index[ID]].MezType == Enums.eMez.Placate))
                        {
            ...
            for (int index = 0; index <= num1; ++index)
            {
                if (shortFx.Index[index] <= -1 || !pBase.Effects[shortFx.Index[index]].DisplayPercentage) continue;
                shortFx.Value[index] *= 100f;
                shortFx.ReSum();
                break;
            }
            ...
            for (int index = 0; index <= num2; ++index)
            {
                if (s2.Index[index] <= -1 || !pBase.Effects[s2.Index[index]].DisplayPercentage) continue;
                s2.Value[index] *= 100f;
                s2.ReSum();
                break;
            }
        ...
        void PairedList_Hover(object Sender, int Index, Enums.ShortFX Tag)
        {
            ...
            if (Tag.Present)
            {
                ...
                for (int index1 = 0; index1 <= num1; ++index1)
                {
                    if (Tag.Index[index1] == -1 ||
                        power.Effects[Tag.Index[index1]].EffectType == Enums.eEffectType.None) continue;
                ...
                for (int index = 0; index <= num3; ++index)
                {
                    if (power.Effects[Tag.Index[index]].EffectType == Enums.eEffectType.None) continue;
                    if (empty2 != string.Empty)
                        empty2 += "\r\n";
        ...
        void SetDamageTip()
        {
            ...
            for (int index = 0; index <= num4; ++index)
            {
                ...
                if (effect.EffectType != Enums.eEffectType.Damage) continue;
        ...
        public void SetEnhancement(I9Slot iEnh, int iLevel = -1)
        {
            ...
            if (TabPage > 1 || iEnh.Enh < 0) return;
        ...
        {
            if (isFX.Index == null) return false;
          ...
          string SpecialTitle = "")
        {
            ...
            else
            {
                ...
                for (int index = 0; index <= num1; ++index)
                {
                    if (!shortFxArray1[index].Present) continue;
                    string Suffix = string.Empty;
