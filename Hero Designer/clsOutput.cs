    ...
    public class clsOutput
    {
        ...
        public clsOutput()
        {
            ...
            if (MidsContext.Config.ExportTarget < 0 | MidsContext.Config.Export.FormatCode.Length == 0)
            {
                ...
                int num = (int)Interaction.MsgBox((object)"No formatting codes found, resetting to defaults.", MsgBoxStyle.Information, (object)"Huh");
            }
            if (MidsContext.Config.ExportScheme < 0 | MidsContext.Config.Export.ColorSchemes.Length == 0)
            {
                ...
                int num = (int)Interaction.MsgBox((object)"No colour schemes found, resetting to defaults.", MsgBoxStyle.Information, (object)"Huh");
            }
