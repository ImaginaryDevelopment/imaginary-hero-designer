    ...
    public class clsOutput
    {
        ...
        public clsOutput()
        {
            ...
            if (MidsContext.Config.ExportScheme < 0 | MidsContext.Config.Export.ColorSchemes.Length == 0)
            {
                ...
                int num = (int)Interaction.MsgBox("No color schemes found, resetting to defaults.", MsgBoxStyle.Information, "Huh");
            }
        ...
        public string Build(string iDataLink)
        {
            ...
            string str3 = str1 + this.formatColor(this.formatBold(str2 + " Build by Mids' Reborn : Hero Designer " + MainModule.MidsController.HeroDesignerVersion.ToString()), ExportConfig.Element.Heading) + this.LineBreak() + this.formatColor(this.formatBold(@"http://midsreborn.com"), ExportConfig.Element.Heading) + this.LineBreak();
