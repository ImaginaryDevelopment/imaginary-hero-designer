...
namespace Base.Data_Classes
{
  public class Character
  {
    ...
    public int Level
    {
      get
      {
        ...
        else
        {
          ...
          {
            int val1 = this.GetFirstAvailablePowerLevel(0);
            if (val1 < 0)
              val1 = 49;
    ...
    protected Character()
    {
      ...
      this.Builds = new Build[1]
      {
        new Build(this, (IList<LevelMap>) DatabaseAPI.Database.Levels)
      };
      this.Reset((Archetype) null, 0);
    }
    ...
    public void Reset(Archetype iArchetype = null, int iOrigin = 0)
    {
      ...
      this.Powersets[7] = powersetIndexes2.Length <= 0 ? (IPowerset) null : powersetIndexes2[0];
    ...
    {
      this.Builds[0] = new Build(this, (IList<LevelMap>) DatabaseAPI.Database.Levels);
    ...
    public static PopUp.PopupData PopEnhInfo(I9Slot iSlot, int iLevel = -1, PowerEntry powerEntry = null)
    {
      ...
      int index1 = popupData1.Add((PopUp.Section) null);
      ...
      else
      {
        ...
        {
          index1 = popupData1.Add((PopUp.Section) null);
        ...
        switch (enhancement.TypeID)
        {
          ...
          case Enums.eType.InventO:
            ...
            int index2 = popupData1.Add((PopUp.Section) null);
            string[] strArray1 = Character.BreakByNewLine(iSlot.GetEnhancementStringLong());
            for (int index3 = 0; index3 <= strArray1.Length - 1; ++index3)
            {
              string[] strArray2 = Character.BreakByBracket(strArray1[index3]);
          ...
          case Enums.eType.SetO:
            if (!string.IsNullOrEmpty(enhancement.Desc))
              popupData1.Sections[index1].Add(enhancement.Desc, PopUp.Colors.Title, 1f, FontStyle.Bold, 0);
            int index4 = popupData1.Add((PopUp.Section) null);
            ...
            for (int index3 = 0; index3 <= strArray3.Length - 1; ++index3)
            {
              ...
              if (!enhancement.HasPowerEffect)
                strArray2 = Character.BreakByBracket(strArray3[index3]);
              else
              ...
              popupData1.Sections[index4].Add(strArray4[0], Color.FromArgb(0, (int) byte.MaxValue, 0), strArray4[1], Color.FromArgb(0, (int) byte.MaxValue, 0), 0.9f, FontStyle.Bold, 0);
            }
            break;
        }
        if (!MidsContext.Config.PopupRecipes)
        {
          ...
          {
            int index3 = popupData1.Add((PopUp.Section) null);
          ...
          popupData1.Add(Character.PopRecipeInfo(enhancement.RecipeIDX, iSlot.IOLevel));
        popupData2 = popupData1;
      }
      return popupData2;
    }
        ...
        for (int index = 0; index <= enhancementSet.Bonus.Length - 1; ++index)
        {
          ...
          if (!string.IsNullOrEmpty(effectString))
          {
            ...
            if (num >= enhancementSet.Bonus[index].Slotted & (enhancementSet.Bonus[index].PvMode == Enums.ePvX.PvE & MidsContext.Config.Inc.PvE | enhancementSet.Bonus[index].PvMode == Enums.ePvX.PvP & !MidsContext.Config.Inc.PvE | enhancementSet.Bonus[index].PvMode == Enums.ePvX.Any))
              section1.Add("(" + (object) enhancementSet.Bonus[index].Slotted + ") " + effectString, PopUp.Colors.Effect, 0.9f, FontStyle.Bold, 0);
            else if (power == null)
              section1.Add("(" + (object) enhancementSet.Bonus[index].Slotted + ") " + effectString, PopUp.Colors.Effect, 0.9f, FontStyle.Bold, 0);
            else
              section1.Add("(" + (object) enhancementSet.Bonus[index].Slotted + ") " + effectString, PopUp.Colors.Disabled, 0.9f, FontStyle.Bold, 0);
          }
        }
