...
namespace Base.Data_Classes
{
    public class Archetype : IComparable
    {
          ...
          : this()
        {
            ...
            this.ClassType = (eClassType)reader.ReadInt32();
        ...
        public int CompareTo(object obj)
        {
            ...
            if (this.Playable & !archetype.Playable)
                ...
                num1 = 1;
            else if (this.ClassType == eClassType.None & archetype.ClassType != eClassType.None)
                num1 = 1;
            else if (this.ClassType != eClassType.None & archetype.ClassType == eClassType.None)
                num1 = -1;
            ...
            else
            {
                ...
                num1 = num2 == 0 ? (this.Column <= archetype.Column ? (this.Column < archetype.Column ? 1 : 0) : 1) : num2;
            }
            return num1;
        }
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (str.IndexOf("KHELDIAN HERO", StringComparison.OrdinalIgnoreCase) > -1)
                        this.ClassType = eClassType.HeroEpic;
