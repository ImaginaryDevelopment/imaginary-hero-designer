                        ...
                        ? EffectType <= effect.EffectType
                            ? EffectType >= effect.EffectType
                                ? !IgnoreED || effect.IgnoreED
                                    ? IgnoreED || !effect.IgnoreED
                                        ? EffectId == effect.EffectId ? Reward == effect.Reward
                                            ? MagnitudeExpression == effect.MagnitudeExpression
                                                ? !effect.isDamage()
                                                    ? effect.EffectType != Enums.eEffectType.ResEffect
                                        ...
                                        string.CompareOrdinal(EffectId, effect.EffectId)
                                        : -1
                                    : 1
                                : -1
                            : 1
