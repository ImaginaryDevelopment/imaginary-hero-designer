...
// Type: Base.Document_Classes.Print
  ...
  public class Print : IDisposable
  {
    ...
    private int PageBorder(Rectangle bounds, PrintPageEventArgs args)
    {
      ...
      if (!string.IsNullOrEmpty(MidsContext.Character.Name))
        s = MidsContext.Character.Name + ": Level " + (object) num3 + " " + MidsContext.Character.Archetype.DisplayName;
      else
        s = "Level " + (object) num3 + " " + MidsContext.Character.Archetype.DisplayName;
      ...
      args.Graphics.DrawString("Page " + (object) this._pageNumber, font2, (Brush) solidBrush, layoutRectangle, format);
    ...
    private static int PpInfo(Rectangle bounds, PrintPageEventArgs args)
    {
      ...
      format.Alignment = StringAlignment.Near;
      format.LineAlignment = StringAlignment.Near;
      string s1 = "Primary Power Set: " + MidsContext.Character.Powersets[0].DisplayName + (object) '\n';
      ...
      int num1 = top + 15;
      string s2 = "Secondary Power Set: " + MidsContext.Character.Powersets[1].DisplayName + (object) '\n';
      ...
      {
        string s3 = "Power Pool: " + MidsContext.Character.Powersets[3].DisplayName + (object) '\n';
      ...
      {
        string s3 = "Power Pool: " + MidsContext.Character.Powersets[4].DisplayName + (object) '\n';
        layoutRectangle = new RectangleF((float) (bounds.Left + 25), (float) num2, (float) bounds.Width, 15f);
        args.Graphics.DrawString(s3, font, (Brush) solidBrush, layoutRectangle, format);
        num2 += 15;
      }
      ...
      {
        string s3 = "Power Pool: " + MidsContext.Character.Powersets[5].DisplayName + (object) '\n';
        layoutRectangle = new RectangleF((float) (bounds.Left + 25), (float) num2, (float) bounds.Width, 15f);
        args.Graphics.DrawString(s3, font, (Brush) solidBrush, layoutRectangle, format);
        num2 += 15;
      }
      ...
      {
        string s3 = "Power Pool: " + MidsContext.Character.Powersets[6].DisplayName + (object) '\n';
        layoutRectangle = new RectangleF((float) (bounds.Left + 25), (float) num2, (float) bounds.Width, 15f);
        args.Graphics.DrawString(s3, font, (Brush) solidBrush, layoutRectangle, format);
        num2 += 15;
      }
      ...
      {
        string s3 = "Ancillary Pool: " + MidsContext.Character.Powersets[7].DisplayName + (object) '\n';
        layoutRectangle = new RectangleF((float) (bounds.Left + 25), (float) num2, (float) bounds.Width, 15f);
        args.Graphics.DrawString(s3, font, (Brush) solidBrush, layoutRectangle, format);
        num2 += 15;
      }
      ...
      PrintPageEventArgs args)
    {
      ...
      else
      {
        ...
        for (int pIndex = this._pIndex; pIndex <= MidsContext.Character.CurrentBuild.Powers.Count - 1; ++pIndex)
        {
          ...
          if (flag2)
          {
            string s1 = "Level " + (object) MidsContext.Character.CurrentBuild.Powers[pIndex].Level + (object) 1 + ":";
            ...
            for (int index = 0; index <= MidsContext.Character.CurrentBuild.Powers[pIndex].Slots.Length - 1; ++index)
            {
              ...
              if (index == 0)
                ...
                str1 = s3 + "(" + (object) MidsContext.Character.CurrentBuild.Powers[pIndex].Slots[index].Level + (object) 1 + ") ";
              if (MidsContext.Character.CurrentBuild.Powers[pIndex].Slots[index].Enhancement.Enh > -1)
              {
                ...
                switch (enhancement.TypeID)
                {
                  case Enums.eType.InventO:
                    s3 = s3 + " - IO:" + (object) MidsContext.Character.CurrentBuild.Powers[pIndex].Slots[index].Enhancement.IOLevel + (object) 1;
                    continue;
      ...
      PrintPageEventArgs args)
    {
      ...
      for (int index1 = 0; index1 <= MidsContext.Character.CurrentBuild.Powers.Count - 1; ++index1)
      {
        ...
        if (flag2)
        {
          string s1 = "Level " + (object) MidsContext.Character.CurrentBuild.Powers[index1].Level + (object) 1 + ":";
          RectangleF layoutRectangle = new RectangleF(bounds.Left + 15f, (float) vPos, bounds.Width, (float) fontSize * 1.25f);
          args.Graphics.DrawString(s1, font, (Brush) solidBrush, layoutRectangle, format);
          ...
          if (MidsContext.Character.CurrentBuild.Powers[index1].Slots.Length > 0)
          {
            ...
            for (int index2 = 0; index2 <= MidsContext.Character.CurrentBuild.Powers[index1].Slots.Length - 1; ++index2)
            {
              ...
              string str3 = str1 + "(";
              str1 = (index2 != 0 ? str3 + (object) (MidsContext.Character.CurrentBuild.Powers[index1].Slots[index2].Level + 1) : str3 + "A") + ")";
            }
            string str4 = str1;
            ...
            if ((double) sizeF.Width > (double) layoutRectangle.Width)
            {
              ...
              if (length > -1)
              {
                str4 = str4.Substring(0, length) + "..." + (object) '\n' + "..." + str4.Substring(length + 2);
